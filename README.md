...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Miner Core-NBminer 42.2-brightgreen" alt="Miner Core"/>
</p>
...
2022-11-?? - 0.00版本
2022.10.20完成的软件的LOGO最终设计方案
2022.10.19Yang第一次提出使用币策这个名字并决定采用币策作为软件的名字
2022.10.18决定采用付费币模式进行软件的使用计费
2022.10.14在Yang的调研下决定设计搬砖机器人
```
