<p align="center">
  <img src="https://github.com/qingshan2048/img/blob/main/bx_monitor_github_logo.png" width="248">
</p>
<p align="center">
...
```bash
2023-00-00 v2024.Lamborghini（即将发布）
2022.12.00 进一步解决了内存泄漏的问题，新增网格交易，外汇网格交易，打水功能
2022.12.00 完成配比功能，规范交易所代码，采用线程执行交易
2022.12.00 增加看门狗功能，恢复价格模块内直接操控交易

2023.07.23 增加了中韩交易所的差价对比监控功能，增加了差价的历史最低统计功能
2023.07.15 优化了监控价格暴涨和监控行情差价的界面显示，显示更清晰明了
2023.07.14 增加了货币组的去重功能，增加了行情监控显示面板的变色显示功能
2023.07.10 增加了监控的加密货币自动存档读取的功能
2023.07.05 增加了监控价格暴涨模式
2023.06.10 修复了软件开启时卡顿的问题并优化了Json数据处理模块
2023.06.08 完善了测试模式的界面
2023.06.07 完善了代理功能的界面
2023.06.01 新增了阻塞请求的处理机制
2023.05.20 版本号由b更名为Lamborghini
2023.05.02 程序由币策对冲交易系统更名为币策分析交易系统
